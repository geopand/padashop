...
Η φόρμα κάνει και έλεγχο σε αυτά που εισάγει ο χρήστης ενώ τον καθοδηγεί με βοηθητικά μηνύματα.
...
Μετά τη διεύθυνση ο χρήστης πρέπει να βάλει τις πληροφορίες κάρτας του.
